...
// Import images
import userExperienceWhite from "../assets/images/user-experience-white.png";
import goodFeedback from "../assets/images/good-feedback.png";
import conversionRate from "../assets/images/conversion-rate.png";
import marketplace3 from "../assets/images/marketplace-3.png";
import costEffectiveWhite from "../assets/images/cost-effective-white.png";
          ...
          <div class="table-overflow">
              ...
              <table cellspacing="0" cellpadding="0" class="main-table">
                <thead>
                  <tr>
                    <th>
                      <h2 class="h5 title">
                        Plan for shopify store development
                      </h2>{" "}
                    </th>
                    <th>
                      <h2 class="h6 plan-name">
                        Standard <br />
                        Plan
                      </h2>{" "}
                    </th>
                ...
                <tbody class="active">
                  <tr>
                    <td>
                      <h3 class="h6">Estimated Cost</h3>
                    </td>
                    <td>
                      <h3 class="h6 price">$3000</h3> <sup>USD</sup>
                    </td>
                    <td>
                      <h3 class="h6 price">$4000</h3> <sup>USD</sup>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div class="table-main">
              <table
                cellspacing="0"
                cellpadding="0"
                class="store-setup-plan inner-plan-setup"
              >
                <thead class={store ? "active" : ""}>
                  <tr>
                        ...
                        >
                          ...
                          >
                            <g clip-path="url(#clip0_1216_5990)">
                              <path
                                d="M15 28.1934C21.9036 28.1934 27.5 22.5969 27.5 15.6934C27.5 8.7898 21.9036 3.19336 15 3.19336C8.09644 3.19336 2.5 8.7898 2.5 15.6934C2.5 22.5969 8.09644 28.1934 15 28.1934Z"
                                fill="#20084D"
                                stroke="#20084D"
                                stroke-width="4"
                              ...
                              ></path>
                              <path
                                d="M20.625 13.8184L15 19.4434L9.375 13.8184"
                                stroke="white"
                                stroke-width="4"
                    ...
                    <th>
                      <a
                        class="button white-button form-model-button"
                        data-toggle="modal"
                        data-target="#form"
                        onClick={openform}
                      >
                  ...
                  <tbody class="active">
                    <tr>
                      ...
                      <td>
                        ...
                        >
                          <path
                            d="M30.1289 4.36321L30.4825 4.00966L30.1289 3.65611L27.9132 1.44039L27.5598 1.08701L27.2063 1.44022L10.918 17.7131L4.84422 11.6542L4.49067 11.3016L4.13755 11.6547L1.92184 13.8704L1.56828 14.2239L1.92184 14.5775L10.5647 23.2204L10.9182 23.5739L11.2718 23.2204L30.1289 4.36321Z"
                            fill="#E94FCA"
                            stroke="#E94FCA"
                          ></path>
                        </svg>
                    ...
                    <tr>
                      <td>
                        Shipping Provider Integration (Through Shopify App)
                      </td>
                      <td>
                        <svg
                          class="correct-icon-table"
                    ...
                    <tr>
                      <td>
                        Custom Payment Gateway Integration (By Developing Custom
                        Shopify App)
                      </td>
                      <td>
                        <svg
                        ...
                        >
                          <path
                            d="M22.4654 23.0518L2.02539 2.61182M22.4654 2.61182L2.02539 23.0518"
                            stroke="black"
                            stroke-width="3.32388"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          ></path>
                        </svg>
                    ...
                    <tr>
                      <td>
                        Custom Shipping Provider Integration (By Developing
                        Custom Shopify App)
                      </td>
                      <td>
                        <svg
            ...
            <div class="table-main">
              <table
                cellspacing="0"
                cellpadding="0"
                class="theme-setup-plan inner-plan-setup"
              >
              ...
              >
                ...
                {Customization && (
                  <tbody class="active">
                    ...
                    <tr>
                      <td colspan="4">
                        <h6 class="title">Collection List Page</h6>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>
                        Custom Collection list page as per the client’s
                        requirements
                      </td>
                      <td>
                        <svg
                    ...
                    <tr>
                      <td colspan="4">
                        <h6 class="title">Collection Page</h6>
                      </td>
                    </tr>
                    <tr>
                      <td>Image</td>
                    ...
                    <tr>
                      <td>
                        <span>Customisation as per theme</span>
                      </td>
                      <td>
                        <svg
                          class="correct-icon-table"
                    ...
                    <tr>
                      <td colspan="4">
                        <h6 class="title">
                          Fully custom design with PSD, Figma or XD
                        </h6>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <a
                          class="button form-model-button"
                          data-toggle="modal"
                          data-target="#form"
                        >
                          Inquire Now
            ...
            <div class="col-md-6 align-items-center">
              <div class="explore-amazing-left section-head-part">
                <h2 class="h2 explore-amazing-heading section-head-title">
                  Benefits of Custom Theme Shopify Store Development
                </h2>
                <p class="explore-amazing-heading-sub-desc section-head-content">
                  Are you planning to build an aesthetically pleasing Shopify
                  design for your online store? Shopify store setup with a
                  premium theme enables you to create aesthetically pleasing
                  designs that attract your targeted niche and fulfill business
                  requirements. Choosing a Shopify store setup with a custom
                  theme can improve brand identity, enhance website speed and
                  performance, and provide a seamless user experience.
                </p>
                <p class="explore-amazing-heading-sub-desc section-head-content">
                  Here are some of the most significant benefits of a Shopify
                  store setup with premium theme.
                </p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="explore-amazing-right">
                <div class="explore-amazing-box">
                  <div class="explore-amazing-icon-main">
                    <img
                      loading="lazy"
                      src={userExperienceWhite}
                      width="40px"
                      height="40px"
                      alt="Unique Custom-Built User Experience"
                    />
                  </div>
                  <div class="explore-amazing-content">
                    <h3 class="h5 explore-amazing-title">
                      Unique Custom-Built User Experience
                    </h3>
                    <p class="explore-amazing-desc">
                      UI/UX designs can kill or cure your Shopify store's
                      success. Shopify store development with a custom theme
                      allows you to create cutting-edge user experiences
                      tailored to your brand identity. It enables you to create
                      mobile-friendly, fully responsive, and unique design
                      themes that deliver original custom-built user
                      experiences.
                    </p>
                  </div>
                </div>
                <div class="explore-amazing-box">
                  <div class="explore-amazing-icon-main">
                    <img
                      ...
                      width="40px"
                      height="40px"
                      alt="Enhanced Shopify Store Performance"
                    />
                  </div>
                  <div class="explore-amazing-content">
                    <h3 class="h5 explore-amazing-title">
                      Enhanced Shopify Store Performance
                    </h3>
                    <p class="explore-amazing-desc">
                      Shopify store development with a custom theme eliminates
                      premade Shopify theme's problem of unnecessary homage and
                      unusable functionality loading. Custom Shopify theme for
                      store development will allow you to create an attractive
                      and fully responsive design. It ensures faster page
                      loading speed and enhanced store performance.
                    </p>
                  </div>
                </div>
                <div class="explore-amazing-box">
                  <div class="explore-amazing-icon-main">
                    <img
                      ...
                      width="40px"
                      height="40px"
                      alt="Accelerates Customer Conversion Rates &amp; Retention Ration"
                    />
                  </div>
                  <div class="explore-amazing-content">
                    <h3 class="h5 explore-amazing-title">
                      Accelerates Customer Conversion Rates &amp; Retention
                      Ration
                    </h3>
                    <p class="explore-amazing-desc">
                      Shopify store development with a custom theme is the most
                      preferred solution in recent times as it offers absolutely
                      user-friendly and interactive design. It helps to attract
                      more visitors and makes them buy products or services from
                      your Shopify store. Which ultimately boosts customer
                      conversion rates and improves the retention ratio.
                    </p>
                  </div>
                </div>
                <div class="explore-amazing-box">
                  <div class="explore-amazing-icon-main">
                    <img
                      ...
                      width="40px"
                      height="40px"
                      alt="Optimizes the Brand Identity"
                    />
                  </div>
                  <div class="explore-amazing-content">
                    <h3 class="h5 explore-amazing-title">
                      Optimizes the Brand Identity
                    </h3>
                    <p class="explore-amazing-desc">
                      Shopify store setup with a custom theme allows store
                      owners to create unique and original designs according to
                      their ideal customers and business requirements. Shopify
                      store setup with premium theme is the best way to enhance
                      brand identity and enables you to stand out firmly in this
                      competitive digital world. It helps you to get a more
                      loyal customer base and sales growth.
                    </p>
                  </div>
                </div>
                <div class="explore-amazing-box">
                  ...
                  <div class="explore-amazing-content">
                    ...
                    <p class="explore-amazing-desc">
                      Premade Shopify themes need to hire Shopify developers and
                      buy additional plugins for customization, resulting in
                      additional ongoing costs. Shopify store setup with premium
                      theme minimizes the requirement of third-party apps,
                      hiring Shopify experts, and plugins. Initially, upfront
                      costs are high, but for long-run goals, a Shopify store
                      setup with premium theme is very cost-effective.{" "}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="section-head-part">
            <h2 class="section-head-title">
              Top-Notch Shopify Store Setup with Premium Theme Services We Offer
            </h2>
          </div>
              ...
              <div class="single-services-box">
                <div class="icon-main">
                  <img
                    ...
                    width="82px"
                    height="82px"
                    src="../assets/images/design-layout-adjust.png"
                    alt="Design Layout Adjustments"
                  />
                  <img
                    loading="lazy"
                    ...
                    width="82px"
                    height="82px"
                    src="../assets/images/design-layout-adjust-hover.png"
                    alt="Design Layout Adjustments"
                  />
                </div>
                <div class="services-content">
                  ...
                  <p class="text">
                    As a Shopify store setup with premium theme services
                    provider, CodeLoom Nexus specialize in adjusting the most
                    influential part of the online store design layout. We offer
                    freedom to sellers to adjust design layout to deliver an
                    intuitive user experience and build a strong brand identity.{" "}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="single-services-box">
                <div class="icon-main">
                  <img
                    ...
                    width="82px"
                    height="82px"
                    src="../assets/images/typography-adjust.png"
                    alt="Typography Adjustments"
                  />
                  <img
                    loading="lazy"
                    class="icon hover-image"
                    width="82px"
                    height="82px"
                    src="../assets/images/typography-adjust-hover.png"
                    alt="Typography Adjustments"
                  />
                </div>
                <div class="services-content">
                  ...
                  <p class="text">
                    A team of Shopify experts at CodeLoom Nexus uses their
                    strong insight into the latest eCommerce market and
                    extensive expertise to choose appropriate font sizes and
                    styles. This typography adjustment helps to tone the design,
                    create emphasis, and improve readability.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="single-services-box">
                <div class="icon-main">
                  <img
                    ...
                    width="82px"
                    height="82px"
                    src="../assets/images/mobile-first-approach.png"
                  ...
                  <img
                    ...
                    width="82px"
                    height="82px"
                    src="../assets/images/mobile-first-approach-hover.png"
                    alt="Mobile First Approach"
                  />
                </div>
                <div class="services-content">
                  ...
                  <p class="text">
                    As a leading Shopify store setup with premium theme company,
                    we have a great command over building fully responsive
                    design layouts. Our skilled Shopify experts create
                    completely responsive design layouts that adopt different
                    devices &amp; screen sizes very well.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="single-services-box">
                <div class="icon-main">
                  <img
                    ...
                    width="82px"
                    height="82px"
                    src="../assets/images/seo-friendly-structure.png"
                  ...
                  <img
                    ...
                    width="82px"
                    height="82px"
                    src="../assets/images/seo-friendly-structure-hover.png"
                    alt="SEO-Friendly Structure"
                  />
                </div>
                <div class="services-content">
                  ...
                  <p class="text">
                    Our team of Shopify developers are experts in optimizing
                    store navigations, using descriptive file names for images
                    and descriptive links for interlinks. As a top Shopify store
                    setup with a custom theme agency, we have empowered all our
                    clients with top search engine ranking and boosted customer
                    engagement. Logo and branding integration
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="single-services-box">
                <div class="icon-main">
                  <img
                    ...
                    width="82px"
                    height="82px"
                    src="../assets/images/custom-functionality.png"
                  ...
                  <img
                    ...
                    width="82px"
                    height="82px"
                    src="../assets/images/custom-functionality-hover.png"
                    alt="Custom Functionality"
                  />
                </div>
                <div class="services-content">
                  ...
                  <p class="text">
                    CodeLoom Nexus is the best Shopify store setup with
                    premium theme services provider in creating custom
                    functionalities tailored to business requirements and
                    targeted audiences. We guarantee the effective traceability
                    of operations, scalability, flexibility, rich user
                    experience and a sales-oriented Shopify store with custom
                    functionalities.
                  </p>
                </div>
              </div>
