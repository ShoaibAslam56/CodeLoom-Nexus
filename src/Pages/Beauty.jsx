...
import beautyAndWellnessStore from "../assets/images/beauty-and-wellness-store.png";
            ...
            <ul class="breadcrumb">
              ...
              <li>
                <span class="medium-text">
                  Beauty & Wellness Store Development Company
                </span>
              </li>
            </ul>
          </div>
              ...
              <div class="page-main-banner-content">
                <div class="page-main-banner-content-list">
                  ...
                  <div class="large-text content">
                    <p class="text">
                      We are a beauty store development company offering beauty
                      & wellness store setup services for individuals and
                      businesses looking to expand their presence in the
                      industry. Right from concept creation to store design and
                      operational support, we provide expert guidance that helps
                      in creating digital retail spaces that cater to a global
                      customer base. Our focus on current trends backed by
                      sustainable practices brings out unique beauty and
                      wellness visions to life in this competitive marketplace.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="left-content">
                <div class="section-head-part">
                  <h2 class="section-head-title title">
                    <span>Beauty & Wellness </span> Store Setup Services
                  </h2>
                </div>
                <p>
                  We provide customized solutions to match your unique brand
                  visions that help in targeting the right markets. Our
                  end-to-end solutions cover every aspect of beauty supply store
                  development. Our expertise helps in defining client's visions
                  and unique selling proposition. The services that we provide
                  aims to streamline the complex process of setting up a online
                  beauty and wellness store, ensuring a polished result that
                  engages users and boosts business growth.
                </p>
