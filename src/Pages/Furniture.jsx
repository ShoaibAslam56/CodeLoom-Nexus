...
import homeDecorStoreSolutionsBanne from "../assets/images/home-decor-store-solutions-banne.png";
            ...
            <ul class="breadcrumb">
              ...
              <li>
                <span class="medium-text">
                  Furniture Ecommerce Development Services
                </span>
              </li>
            </ul>
          </div>
              ...
              <div class="page-main-banner-content">
                <div class="page-main-banner-content-list">
                  ...
                  <div class="large-text content">
                    <p class="text">
                      Turn your vision into digital reality with our specialized
                      home decor ecommerce solutions. You can trust our expert
                      team to provide you with elegant digital platforms that
                      show off your furniture and home decor collection using
                      cutting-edge 3D visualization and easy-to-use shopping
                      interfaces. Our multi-vendor furniture marketplace
                      development includes advanced room planning tools and a
                      powerful market ecosystem. It is our commitment to
                      excellence that has made us a leading custom furniture
                      website design and development company today.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="left-content">
                <div class="section-head-part">
                  <h2 class="section-head-title title">
                    <span>Home Decor</span> Store Solutions
                  </h2>
                </div>
                <p>
                  Our professional decor store development services ensure that
                  your digital showroom incorporates smart room visualization
                  algorithms and has a reliable checkout system. Our development
                  team prioritizes design elements that replicate the warmth of
                  physical showrooms. Moreover, our solid infrastructure takes
                  care of vendor relationships, stock levels and business
                  intelligence. Build your own home decor ecommerce site with
                  our mobile optimized approach that ensures performance across
                  multiple devices.
                </p>
            ...
            <div class="col-lg-5 col-md-12">
              <div class="image">
                <img
                  width="474px"
                  height="402px"
                  src={homeDecorStoreSolutionsBanne}
                  loading="lazy"
                  alt="Jewelry Store"
                />
              </div>
