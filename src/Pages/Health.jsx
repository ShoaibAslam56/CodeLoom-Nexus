...
import nurseryECommerceSite from "../assets/images/nursery-e-commerce-site.png";
            ...
            <div class="page-main-banner-colm col-lg-7 col-md-7">
              <div class="page-main-banner-content">
                <div class="page-main-banner-content-list">
                  <h1 class="title">Health and Wellness Website Development</h1>
                  <div class="large-text content">
                    <p class="text">
                      We are a specialized Nutritional Supplements Website
                      Development Company providing Affordable Supplements Store
                      Website Design and Custom Shopify Development for
                      Supplements for companies who Sell Nutritional Products
                      Online. Our team of Professional Nutrition Store Designers
                      create mobile-responsive design that ensures accessibility
                      across multiple devices.
                    </p>
                    <p class="text">
                      Our focus on user experience, technical performance, and
                      strategic design helps nutritional supplement brands in
                      creating compelling online stores that drive sales and
                      customer engagement.
                    </p>
                  </div>
                </div>
              ...
              <div class="left-content">
                <div class="section-head-part">
                  <h2 class="section-head-title title">
                    <span>Custom Shopify</span> Development for Supplements
                  </h2>
                </div>
                <p>
                  Businesses specializing in nutritional supplement stores can
                  now Create a Supplements Shopify Store using our robust,
                  flexible solutions. Our Custom Supplements Store Development
                  provides supplement brands with a powerful, flexible platform
                  to showcase products, engage customers, and drive online
                  sales. By partnering with our Supplements Store Development
                  Agency, businesses can create a compelling digital storefront
                  that stands out in the competitive health and wellness market.
                </p>
