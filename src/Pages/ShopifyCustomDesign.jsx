...
import inDepthClientConsultation from "../assets/images/in-depth-client-consultation.png";
import industryTopShopifyPlusDevelopers from "../assets/images/industry-top-shopify-plus-developers.png";
import responsiveShopifyPlusStore from "../assets/images/responsive-shopify-plus-store.png";
import standardOptimizedCoding from "../assets/images/standard-optimized-coding.png";
import quickTimeLaunch from "../assets/images/quick-time-launch.png";
              ...
              <div class="page-main-banner-content">
                <div class="page-main-banner-content-list">
                  ...
                  <div class="large-text content">
                    <p class="text">
                      Are you planning to hire Shopify Plus store setup with
                      custom design company to develop a CRO-optimized store
                      adorned with custom-built features?
                    </p>
                    <p class="text">
                      CodeLoom Nexus, as a dynamic Shopify Plus development
                      services company, immerses ourselves in client
                      consultation to identify the exact nature of the brand,
                      custom feature requirements, specific checkout
                      customization requirements, business goals, navigation
                      setup requirements, and more. We guarantee a Shopify Plus
                      store packed with advanced features that ensure a
                      custom-built user experience and a dollar business.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="section-head-part">
            <h2 class="section-head-title">
              Reasons to Choose CodeLoom Nexus for Shopify Plus Store Setup
              with Premium Theme
            </h2>
            <p class="section-head-content">
              We have delivered exceptional Shopify Plus store setup with custom
              theme services for numerous clients who are well-versed with their
              niche requirements, scope of work, navigation setup, and Shopify
              market insights.{" "}
            </p>
          </div>
              ...
              <div class="why-you-choose-us-points">
                <div class="icon-main">
                  <img
                    loading="lazy"
                    class="icon"
                    src={inDepthClientConsultation}
                    width="70px"
                    height="70px"
                    alt="In-depth Client Consultation"
                  />
                </div>
                <h3 class="h6 title">In-depth Client Consultation</h3>
                <p class="medium-text text">
                  You can also reach out to us if you only have ideas for store
                  development and expected design layout. Our Shopify Plus
                  experts will suggest the best Shopify themes that mirror your
                  brand identity and boost customer engagement &amp;
                  scalability.
                </p>
              </div>
            </div>
              ...
              <div class="why-you-choose-us-points">
                <div class="icon-main">
                  <img
                    loading="lazy"
                    class="icon"
                    src={industryTopShopifyPlusDevelopers}
                    width="70px"
                    height="70px"
                    alt="Industry Top Shopify Plus developers"
                  />
                </div>
                <h3 class="h6 title">Industry Top Shopify Plus developers</h3>
                <p class="medium-text text">
                  Our in-house team of Shopify Plus developers brings years of
                  extensive experience and has hands-on experience working with
                  enterprise-level global clients. We are committed to
                  addressing clients' issues and concerns on time.
                </p>
              </div>
            </div>
            <div class="col-md-4 col-sm-6 col-spacing-bottom">
              <div class="why-you-choose-us-points">
                <div class="icon-main">
                  <img
                    loading="lazy"
                    class="icon"
                    src={responsiveShopifyPlusStore}
                    width="70px"
                    height="70px"
                    alt="Fully Responsive Shopify Plus Store"
                  />
                </div>
                <h3 class="h6 title">Fully Responsive Shopify Plus Store</h3>
                <p class="medium-text text">
                  Our Shopify Plus developers specialize in setting up Shopify
                  Plus themes as per target audience behaviour and expectations.
                  We guarantee Shopify Plus websites that is fully responsive to
                  desktop and mobile.
                </p>
              </div>
            </div>
              ...
              <div class="why-you-choose-us-points">
                <div class="icon-main">
                  <img
                    loading="lazy"
                    class="icon"
                    src={standardOptimizedCoding}
                    width="70px"
                    height="70px"
                    alt="Standard Optimized Coding"
                  />
                </div>
                <h3 class="h6 title">Standard Optimized Coding</h3>
                <p class="medium-text text">
                  Our Shopify Plus experts are trained to follow
                  industry-standard code optimization practices and Shopify
                  guidelines to ensure better readability, consistency, and page
                  loading speed and minimize chances of code break.
                </p>
              </div>
            </div>
            <div class="col-md-4 col-sm-6 col-spacing-bottom">
              <div class="why-you-choose-us-points">
                <div class="icon-main">
                  <img
                    ...
                    width="70px"
                    height="70px"
                    alt="Quick time to launch"
                  />
                </div>
                <h3 class="h6 title">Quick time to launch</h3>
                <p class="medium-text text">
                  Our dedicated Shopify Plus expert ensures uninterrupted,
                  efficient, and bug-free development to help clients reach the
                  market earlier, capture a wide audience and boost sales by
                  200%.
                </p>
              </div>
            </div>
      ...
      >
        <div class="container">
          <div class="section-head-part">
            ...
            <p class="section-head-content">
              As a leading Shopify Plus store setup with premium theme company,
              our top Shopify Plus experts are committed to following an agile
              and effective development process. It ensures glitch-free,
              conversion-ready development quickly.
            </p>
          </div>
            ...
            <div class="workflow-step-wrap row-mb-minus">
              <div class="workflow-single col-spacing-bottom">
                <div class="workflow-single-back">
                  ...
                  <ul class="small-text workflow-content">
                    <li>
                      Our Shopify Plus developers discuss with clients to
                      identify what are the exact project needs.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="workflow-single col-spacing-bottom">
                <div class="workflow-single-back">
                  ...
                  <ul class="small-text workflow-content">
                    <li>
                      After understanding clients' exact requirements, we
                      prepare strategic planning for an uninterrupted
                      development process. It helps us to provide the final
                      product that quickly exceeds clients' unique requirements.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="workflow-single col-spacing-bottom">
                <div class="workflow-single-back">
                  ...
                  <ul class="small-text workflow-content">
                    <li>
                      Our Shopify Plus experts utilize ever-growing tools,
                      techniques, and extensive expertise to provide a flawless
                      user experience and Shopify Plus store with maximum
                      scalability.
                    </li>
                  </ul>
                </div>
                ...
                <div class="workflow-single-back">
                  ...
                  <ul class="small-text workflow-content">
                    <li>
                      ...
                      specialist ensures the quality of the website by
                      performing rigorous quality testing.
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div class="workflow-single-back">
                  ...
                  <ul class="small-text workflow-content">
                    <li>
                      ...
                      end-to-end functionality from the client. After getting
                      approval from the end-user, the Shopify store is ready to
                      deploy.
                    </li>
                  </ul>
                </div>
      ...
      <section id="big-empire-banner" class="big-empire-banner section-spacing">
        <div class="container">
          <div class="big-empire-banner-main">
            <div
              class="big-empire-banner-left"
              style={{ width: "100%", textAlign: "center" }}
            >
              <h3 class="big-empire-banner-title">
                We are all set to setup your <span>Shopify Plus store!</span>
              </h3>
              <p class="big-empire-banner-sub-desc">
                Let's get started building your million-dollar online business!
              </p>
              <NavLink to="/contact-us">
                <div class="button white-button">Click to Reach Us</div>
              </NavLink>
            </div>
          </div>
        </div>
