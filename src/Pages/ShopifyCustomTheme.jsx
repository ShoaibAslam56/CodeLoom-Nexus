              ...
              <div class="page-main-banner-content">
                <div class="page-main-banner-content-list">
                  ...
                  <div class="large-text content">
                    <p class="text">
                      Are you planning to scale your Shopify business with the
                      ever-growing features and functionalities of Shopify Plus?
                    </p>
                    <p class="text">
                      CodeLoom Nexus is the best Shopify Plus store setup
                      with custom/premium theme companies across the globe, with
                      more than 8 years in the core Shopify industry. Our
                      experts combine world-class Shopify Plus platform
                      expertise with advanced tools and technology to develop a
                      solution that creates high-volume business for our
                      clients.
                    </p>
                  </div>
                </div>
...
export default ShopifyCustomTheme;
